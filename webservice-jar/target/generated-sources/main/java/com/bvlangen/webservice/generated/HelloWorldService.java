 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://helloworld.webservice.com", wsdlLocation = "file:/C:/sandboxes/WebServiceWsImport/webservice-jar/src/main/resources/wsdl/test.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://helloworld.webservice.com", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/sandboxes/WebServiceWsImport/webservice-jar/src/main/resources/wsdl/test.wsdl");
    ...
    public HelloWorld getHelloWorld() {
        return super.getPort(new QName("http://helloworld.webservice.com", "HelloWorld"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorld(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloworld.webservice.com", "HelloWorld"), HelloWorld.class, features);
    }
